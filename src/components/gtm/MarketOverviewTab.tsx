...
export const MarketOverviewTab = () => {
  ...
  const chartData = geoData?.map(state => ({
    name: state.state_code,
    creators: state.creator_count,
    value: state.market_value / 1000000000, // Convert to billions
  })) || [];
    ...
    <div className="space-y-6">
            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between mb-2">
                <div className="text-muted-foreground">
                  {getIconForMetric(metric.metric_name)}
                </div>
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Geographic distribution of active creators and estimated market opportunity
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Market Size: {(segment.market_size / 1000000).toFixed(1)}M creators
                  </p>
                ...
                <div className="text-right ml-4">
                  ...
                  <span className={`inline-block mt-2 px-3 py-1 rounded-full text-xs font-medium ${
                    segment.potential_rating === "Very High Potential" 
                      ? "bg-green-500/10 text-green-600 dark:text-green-400" 
                      : segment.potential_rating === "High Potential"
